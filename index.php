...
<html class="no-js" lang="">
    <head>
        ...
        <title>Eric Pierpont && LAMP Developer && WordPress Monkey</title>
				...
				<section id="about-me">
					...
					<div class="row no-gutters">
						...
						<div class="col-5 experience">
							...
							<div class="row no-gutters">
								<div class="col-3 date">10.07 - 06.10</div>
								<div class="col-9"><strong>Resort Group</strong> | <span>Steamboat Springs, CO</span><br/>
									Internet Marketing Specialist</div>
							</div>

							<div class="row no-gutters">
								<div class="col-3 date">11.06 - 10.07</div>
								<div class="col-9"><strong>Sunday River</strong> | <span>Newry, ME</span><br/>
									Internet Marketing Specialist</div>
							</div>
							...
							<div class="row no-gutters">
								<div class="col-3 date">09.02 - 05.06</div>
								<div class="col-9"><strong>The University of Maine </strong> | <span>Orono, ME</span><br/>
